...
- **Committed** as `8483e5f` on `master` ("Phase 5 (Increment 1): JavaFX player UI …") — engine read-seam, `NodeRuntime`, Gradle, `ui/` + `resources/`, all 5 screens + fidelity/responsiveness passes. Working tree clean. Commit convention: NO `Co-Authored-By` trailer.
