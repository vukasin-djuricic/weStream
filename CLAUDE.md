...
**Next — Phase 5: media/player** (`media/`): JavaFX + vlcj/libVLC single-window app, driving `SlidingWindowPicker.setPlayhead` from real playback; Gradle + jpackage/jlink land here. Before/with Phase 5, consider folding in the deferred engine/transfer gaps below when robustness matters.
