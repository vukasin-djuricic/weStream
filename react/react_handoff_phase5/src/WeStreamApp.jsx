...
export default function WeStreamApp() {
  ...
  return (
    <div className="ws-scroll" style={css("height:100vh;display:flex;flex-direction:column;background:#0f0d15;color:#f4f1f8;font-family:'Manrope',system-ui,sans-serif;overflow:hidden")}>
      ...
      {/* ===== TITLE BAR ===== */}
      <header style={css("height:46px;flex-shrink:0;display:flex;align-items:center;justify-content:space-between;padding:0 14px;background:linear-gradient(180deg,#181320,#141019);border-bottom:1px solid #272131")}>
        <div style={css("display:flex;align-items:center;gap:14px")}>
          <div style={css("display:flex;gap:8px;padding-right:6px")}>
            <span style={css("width:12px;height:12px;border-radius:50%;background:#ec6a5e")} />
            <span style={css("width:12px;height:12px;border-radius:50%;background:#f4bf4f")} />
            <span style={css("width:12px;height:12px;border-radius:50%;background:#61c554")} />
          </div>
        ...
        <div style={css("display:flex;align-items:center;gap:8px;font-family:'JetBrains Mono',monospace;font-size:11.5px;white-space:nowrap;flex-shrink:0")}>
          <div style={css("display:flex;align-items:center;gap:7px;padding:5px 11px;background:rgba(70,211,154,0.10);border:1px solid rgba(70,211,154,0.28);border-radius:999px;color:#74e3b0")}>
          ...
          <div style={css("display:flex;align-items:center;gap:6px;padding:5px 11px;background:#1b1722;border:1px solid #2c2638;border-radius:999px;color:#ada3bd")}>
            <span style={{ color: "#c64ff0" }}>●</span> 24 peers
          </div>
        ...
        <div style={css("display:flex;gap:16px;color:#756c85;font-size:16px;padding-right:4px")}>
      ...
      <div style={css("flex:1;display:flex;min-height:0")}>
        ...
        <main className="ws-scroll" style={css("flex:1;min-width:0;overflow:auto;background:radial-gradient(1100px 600px at 78% -8%, rgba(198,79,240,0.07), transparent 60%), #0f0d15")}>
          ...
          {screen === "dht" && <DhtScreen buckets={buckets} />}
        </main>
      </div>
    </div>
  );
    ...
    <section style={css("padding:22px 24px 30px")}>
      ...
      <div style={css("display:flex;align-items:center;gap:24px;padding:18px 20px;background:linear-gradient(120deg,#1d1430,#15111d 70%);border:1px solid #34284a;border-radius:16px;margin-bottom:16px;flex-wrap:wrap")}>
        <div style={css("flex:1;min-width:280px")}>
          ...
          <div style={css("font:600 16px 'JetBrains Mono';color:#e7e1ef;letter-spacing:0.04em;word-break:break-all")}>4287ad37 811db73f 862115ba 0960cc6c 9d54569e</div>
          <div style={css("font:500 11.5px 'JetBrains Mono';color:#8b8299;margin-top:6px")}>udp://127.0.0.1:1100 · seed node · up 14m 22s</div>
        </div>
        <div style={css("display:flex;gap:26px")}>
          {[["BUCKETS", "11", "#f4f1f8", "/160"], ["CONTACTS", "38", "#c08fe8"], ["STORED KEYS", "7", "#74e3b0"]].map(([l, v, c, suf]) => (
